...
env = StableBaselinesGodotEnv(env_path=args.env_path, show_window=args.viz, n_parallel=args.n_parallel, speedup=args.speedup)
env = VecMonitor(env)

if args.resume_model_path is None:
    model = PPO("MultiInputPolicy", env, ent_coef=0.0001, verbose=2, n_steps=64, tensorboard_log=args.experiment_dir) #era 32
else:
